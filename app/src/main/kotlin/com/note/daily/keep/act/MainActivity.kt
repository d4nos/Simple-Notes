...
import com.note.daily.keep.adap.NotesPagerAdapter
import com.note.daily.keep.db.NotesDatabase
import com.note.daily.keep.dg.*
import com.note.daily.keep.ext.*
import com.note.daily.keep.f.TextFragment
import com.note.daily.keep.h.*
import com.note.daily.keep.m.Note
import com.note.daily.keep.pro.VActivity
...
class MainActivity : SimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        checkAppOnSDCard()
        setupSearchButtons()
        pro.setOnClickListener { VActivity.open(this) }
